...
while continue2 == "Y":
    ...
    while continue3 == "Y":    
        if Oper == "1":
            ...
            print("")
            fromL = input("From what Language do you want to translate: ")
            print("")
            to= input("What do you wan to translate it into: ")

            #translate text
            translated_text = translator.translate(text, src=fromL, dest=to)
            print("")
