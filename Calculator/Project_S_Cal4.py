...
while continue2 == "Y":
    print("")
    Oper = str(input("Enter the operation (1 - Addition, 2 - Subtraction, 3 - Multiply, 4 - Division, 5 - Exponent, 6 - Floor Division, 7 - Less Than, 8 - Greater Than, 9 - Equal, 10 - Factorial, 11 - Square Root, 12 - Cube Root) : "))
    Operation = 0
    continue3 = "Y"
    while continue3 == "Y":
